from . import (
    ...
    admin, subscription, bulk_import, admission_router as admissions,
    timetable, timetable_auto,
    public, exports, backup, badges,
    headteacher, dean, subjects, class_teacher,
    print as print_router, teacher_analytics, forecast_router as forecasts
)
...
def register_routers(app):
    ...
    routers = [
        ...
        admin.router, subscription.router, bulk_import.router,
        ...
        print_router.router, teacher_analytics.router
    ]
    
    # Check for admissions and forecasts specifically as they might have different names in files
    # Depending on the exact file content (some files use 'router', some might not)
    
    for r in routers:
        app.include_router(r)

    # Handle specialized/aliased routers if necessary
    try:
